...
type CountryWithCurrency = [string, string, string];  //add string*3
...
type lang= readonly[string, string]        //create type lang
const countryLanguage:lang = ["Greece", "Greek"];  //add lang
