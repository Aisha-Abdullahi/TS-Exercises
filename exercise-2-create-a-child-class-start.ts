...
class Currency {
     name: string;     //remove private, make it public for line 54
    private code: string;
...
private banknotes: number[]
    ...
    constructor(name: string, code: string, symbol: string, banknotes: number[]) { //added banknotes: number[] 
        // Fix this call to the parent constructor.

        super(name, code, symbol);  //added symbol
...
this.banknotes=banknotes;
    ...
    public describeBankNotes() {   //replace private with public
