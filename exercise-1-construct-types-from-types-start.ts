...
type PartialCountry = Partial <Country>;   //replace 'type PartialCountry = Country;' with 'type PartialCountry = Partial<Country>'
...
type CompleteCountry = Required<Country>;    //added required<>
...
type CountryWithPopulation = Pick<Country, "name"|"code"|"population">;     //replaced 'type CountryWithPopulation = Country;' with 'type CountryWithPopulation = Pick<Country, "name"|"code"|"population">'
...
type CountryWithoutPopulation = Omit<Country, "population">;    //replaced 'type CountryWithoutPopulation = Country;' with 'type CountryWithoutPopulation = Omit<Country, "population">'
